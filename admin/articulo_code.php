                    ...
                    INTO
                        articulos
                            (id_categoria, nombre_articulo, titulo,
                              desc_subtitulo1, etiqueta1, descripcion1, imagen1, direccion1,
                              desc_subtitulo2, etiqueta2, descripcion2, imagen2, direccion2,
                              desc_subtitulo3, etiqueta3, descripcion3, imagen3, direccion3,
                              desc_subtitulo4, etiqueta4, descripcion4, imagen4, direccion4,
                              desc_subtitulo5, etiqueta5, descripcion5, imagen5, direccion5,
                              desc_subtitulo6, etiqueta6, descripcion6, imagen6, direccion6,
                              desc_subtitulo7, etiqueta7, descripcion7, imagen7, direccion7,
                              desc_subtitulo8, etiqueta8, descripcion8, imagen8, direccion8,
                              desc_subtitulo9, etiqueta9, descripcion9, imagen9, direccion9,
                              desc_subtitulo10, etiqueta10, descripcion10, imagen10, direccion10,
                              imagen)
                    VALUES
                        ('$id_categoria', '$nombre_articulo', '$titulo',
                          '$subtitulo1', '$etiqueta1', '$descripcion1', '$imagen1', '$direccion1',
                          '$subtitulo2', '$etiqueta2', '$descripcion2', '$imagen2', '$direccion2',
                          '$subtitulo3', '$etiqueta3', '$descripcion3', '$imagen3', '$direccion3',
                          '$subtitulo4', '$etiqueta4', '$descripcion4', '$imagen4', '$direccion4',
                          '$subtitulo5', '$etiqueta5', '$descripcion5', '$imagen5', '$direccion5',
                          '$subtitulo6', '$etiqueta6', '$descripcion6', '$imagen6', '$direccion6',
                          '$subtitulo7', '$etiqueta7', '$descripcion7', '$imagen7', '$direccion7',
                          '$subtitulo8', '$etiqueta8', '$descripcion8', '$imagen8', '$direccion8',
                          '$subtitulo9', '$etiqueta9', '$descripcion9', '$imagen9', '$direccion9',
                          '$subtitulo10', '$etiqueta10', '$descripcion10', '$imagen10', '$direccion10',
                          '$destinobd')";
...
if(isset($_POST['updateArticulobtn'])){
    ...
    if(!in_array($archivo_extension_edit,['jpg'])){
        ...
        if(move_uploaded_file($archivo_edit,$destino_edit)){
            ...
            desc_subtitulo1 ='$edit_subtitulo1', etiqueta1 ='$edit_etiqueta1', descripcion1 ='$edit_descripcion1', imagen1 = '$edit_imagen1', direccion1 = '$edit_direccion1',
            desc_subtitulo2 ='$edit_subtitulo2', etiqueta2 ='$edit_etiqueta2', descripcion2 ='$edit_descripcion2', imagen2 = '$edit_imagen2', direccion2 = '$edit_direccion2',
            desc_subtitulo3 ='$edit_subtitulo3', etiqueta3 ='$edit_etiqueta3', descripcion3 ='$edit_descripcion3', imagen3 = '$edit_imagen3', direccion3 = '$edit_direccion3',
            desc_subtitulo4 ='$edit_subtitulo4', etiqueta4 ='$edit_etiqueta4', descripcion4 ='$edit_descripcion4', imagen4 = '$edit_imagen4', direccion4 = '$edit_direccion4',
            desc_subtitulo5 ='$edit_subtitulo5', etiqueta5 ='$edit_etiqueta5', descripcion5 ='$edit_descripcion5', imagen5 = '$edit_imagen5', direccion5 = '$edit_direccion5',
            desc_subtitulo6 ='$edit_subtitulo6', etiqueta6 ='$edit_etiqueta6', descripcion6 ='$edit_descripcion6', imagen6 = '$edit_imagen6', direccion6 = '$edit_direccion6',
            desc_subtitulo7 ='$edit_subtitulo7', etiqueta7 ='$edit_etiqueta7', descripcion7 ='$edit_descripcion7', imagen7 = '$edit_imagen7', direccion7 = '$edit_direccion7',
            desc_subtitulo8 ='$edit_subtitulo8', etiqueta8 ='$edit_etiqueta8', descripcion8 ='$edit_descripcion8', imagen8 = '$edit_imagen8', direccion8 = '$edit_direccion8',
            desc_subtitulo9 ='$edit_subtitulo9', etiqueta9 ='$edit_etiqueta9', descripcion9 ='$edit_descripcion9', imagen9 = '$edit_imagen9', direccion9 = '$edit_direccion9',
            desc_subtitulo10 ='$edit_subtitulo10', etiqueta10 ='$edit_etiqueta10', descripcion10 ='$edit_descripcion10', imagen10 = '$edit_imagen10', direccion10 = '$edit_direccion10',
